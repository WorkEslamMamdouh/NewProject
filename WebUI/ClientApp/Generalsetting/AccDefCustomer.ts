...
namespace AccDefCustomer {
    ...
    function btnAdd_onclick() {
        ...
        //SysSession.CurrentEnvironment.NationalityID != null ? $("#txt_Country").val(SysSession.CurrentEnvironment.NationalityID) : $("#txt_Country").val("null");
        //SysSession.CurrentEnvironment.Currencyid != null ? $("#txt_Currency").val(SysSession.CurrentEnvironment.Currencyid) : $("#txt_Currency").val("null");
    }
    ...
    //    if ((txt_Openbalance.value.trim() == "" || Openbalance <= 0) && txt_Cust_Type.value == "1") {
    ...
    function DisplayData(Selecteditem: Array<A_Rec_D_Customer>) {
    ...
    function AddNewRow() {
        ...
        if (CanAdd) {
            ...
            $("#IDIssueDateH" + CountGrid).val(GetDate());
            $("#IDExpireDateH" + CountGrid).val(GetDate());
